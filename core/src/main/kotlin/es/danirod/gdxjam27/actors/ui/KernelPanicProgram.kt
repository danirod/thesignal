...
class KernelPanicProgram(manager: AssetManager, private val screen: GameScreen) : Table() {
    ...
    private val errorMessage = run {
        val messageCard = manager.get("lostsatellite1.png", Texture::class.java)
        val titleCard = manager.get("lostsatellite2.png", Texture::class.java)
